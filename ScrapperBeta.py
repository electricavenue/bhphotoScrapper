...
#                    incar="normal"
                ...
                if different or Nikon:
                    ...
                    data=[time.strftime("%b %d %Y %H:%M:%S"),"'"+magentoSKU,"'"+str(mfr),"'"+str(code),name,BHSpecialPrice,BHPrice,BHTypeOfSell,BHPriceRebate,BHDateRebate,magentoSpecialPrice,magentoPrice,magentoPriceRebate,magentoDateRebate,UploadType,UploadSpecialPrice,UploadPrice,UploadPriceRebate,UploadDateRebate]
